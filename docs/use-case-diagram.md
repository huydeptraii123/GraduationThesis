...
- **Nhóm 3 — Tính và duyệt phương án cắt**: nhóm ca sử dụng lõi của khóa luận, tách làm hai. "Tính phương án cắt" (PLANNER và ADMIN) chạy trên toàn bộ đơn hàng chưa duyệt để cảnh báo sớm thiếu hụt vật tư, không thay đổi dữ liệu. "Duyệt phương án cắt" (chỉ PLANNER) chốt phương án cho đợt sản xuất sắp tới và là ca sử dụng duy nhất của nhóm này ghi dữ liệu xuống hệ thống. Ca "Xem / xuất kết quả cắt" mở cho cả hai tác nhân vì chỉ đọc lại lịch sử đã chốt — ranh giới phân quyền của nhóm này nằm ở hành vi **ghi**, không nằm ở việc nhìn thấy kết quả. Cả hai đều kéo theo (include) việc sinh nhu cầu cắt từ BOM và chạy thuật toán 4 mức ưu tiên (xem chi tiết luồng trong `docs/sequence-diagrams.md`).
...
| Tính phương án cắt | PLANNER, ADMIN | Chạy thuật toán trên **toàn bộ** đơn hàng chưa duyệt và tồn kho tại thời điểm bấm, không giới hạn ngày giao hay số lượng đơn; chỉ đọc dữ liệu, không lưu lịch sử, phục vụ cảnh báo sớm thiếu hụt vật tư và xuất Excel. |
